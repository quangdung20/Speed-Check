...
try:
    while(True):
        ...
        speed_real_right = 20 + i   # Example data
        speed_set_right = 25 + i    # Example data
        speed_real_left = 15 + i    # Example data
        speed_set_left = 18 + i     # Example data

        # Format the data as a string
        data = f"{speed_real_right},{speed_set_right},{speed_real_left},{speed_set_left};"
        i += 1
